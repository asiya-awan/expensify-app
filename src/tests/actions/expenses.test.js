import {addExpense, setExpenses, startSetExpenses, editExpense, removeExpense, startAddExpense }  from '../../actions/expenses';
...
beforeEach((done) => {
    ...
    database.ref('expense').set(expensesData).then(() => {
        done();
    });
});
